...
public class UIManager : MonoBehaviour
{
    ...
    {
        Debug.Log("Back button pressed - returning to Scenario Select");
        
        // Reset any ongoing scoring
        if (FindFirstObjectByType<ScoringSystem>() != null)
        {
            ScoringSystem.LastResult = null;
            ScoringSystem.LastScenario = null;
        }
        
        // Reset scenario selector state
